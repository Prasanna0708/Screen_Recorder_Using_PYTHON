#import pacakges what we have installed now...opencv-python , pyautogui,numpy by using pip command
import cv2
import numpy as np
import pyautogui
import time
...
#saving screenshot into image
screenShot.save('image.png')
#printing size of the screenshot
